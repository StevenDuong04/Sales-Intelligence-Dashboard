...
def revenue_growth_rate(df, date_column="order_date"):
    """
    Calculates the percentage growth in revenue between the earliest and latest year.

    Compares total revenue from the first recorded year with the most recent
    recorded year to determine overall revenue growth.
    """
...
def average_revenue_per_customer(df):
    ...
    Divides total revenue by the number of unique customers to determine
    the average amount of revenue contributed by each customer.
    """
...
def revenue_per_product(df):
    ...
    Groups transactions by product and sums revenue to identify
    how much revenue each product contributes.
    """
...
def revenue_per_category(df):
    ...
    Groups transactions by category and sums revenue to compare
    revenue performance across different categories.
    """
